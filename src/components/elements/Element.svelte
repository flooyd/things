<script>
  ...
  $: ready
    ? (styleString = `accent-color:${element.accentColor || ""};align-content:${
        ...
        element.borderBlockStyle || ""
      };border-block-width:${element.borderBlockWidth || ""};border-bottom:${
      ...
      };border-collapse:${element.borderCollapse || ""};border-color:${
        element.borderColor || ""
        ...
        element.borderImageRepeat || ""
      };border-image-slice:${
        element.borderImageSlice || ""
      };border-image-source:${
        element.borderImageSource || ""
      };border-image-width:${element.borderImageWidth || ""};border-inline:${
        element.borderInline || ""
      };border-inline-color:${
        ...
        element.borderRightStyle || ""
      };border-right-width:${element.borderRightWidth || ""};border-spacing:${
        element.borderSpacing || ""
        ...
        element.columnWidth || ""
      };columns:${element.columns || ""};contain:${
        element.contain || ""
      };content:${element.content || ""};content-visibility:${
        element.contentVisibility || ""
      };counter-increment:${element.counterIncrement || ""};counter-reset:${
        element.counterReset || ""
      };counter-set:${element.counterSet || ""};cursor:${
        element.cursor || ""
      };direction:${element.direction || ""};display:${
        element.display || ""
      };empty-cells:${element.emptyCells || ""};filter:${
        element.filter || ""
      };flex:${element.flex || ""};flex-basis:${
        element.flexBasis || ""
      ...
      };hanging-punctuation:${element.hangingPunctuation || ""};height:${
        element.height || ""
      };hyphenate-character:${element.hyphenateCharacter || ""};hyphens:${
        element.hyphens || ""
      };image-orientation:${element.imageOrientation || ""};image-rendering:${
        element.imageRendering || ""
      };Deprecatedime-mode:${element.DeprecatedimeMode || ""};inline-size:${
        element.inlineSize || ""
      };inset:${element.inset || ""};inset-block:${
        element.insetBlock || ""
      };inset-block-end:${element.insetBlockEnd || ""};inset-block-start:${
        element.insetBlockStart || ""
      };inset-inline:${element.insetInline || ""};inset-inline-end:${
        element.insetInlineEnd || ""
      };inset-inline-start:${element.insetInlineStart || ""};isolation:${
        element.isolation || ""
      };justify-content:${element.justifyContent || ""};justify-items:${
        element.justifyItems || ""
      };justify-self:${element.justifySelf || ""};left:${
        element.left || ""
      };letter-spacing:${element.letterSpacing || ""};line-break:${
        element.lineBreak || ""
      };line-height:${element.lineHeight || ""};list-style:${
        element.listStyle || ""
      };list-style-image:${element.listStyleImage || ""};list-style-position:${
        element.listStylePosition || ""
      };list-style-type:${element.listStyleType || ""};margin:${
        element.margin || ""
      };margin-block:${element.marginBlock || ""};margin-block-end:${
        element.marginBlockEnd || ""
      };margin-block-start:${element.marginBlockStart || ""};margin-bottom:${
        element.marginBottom || ""
      };margin-inline:${element.marginInline || ""};margin-inline-end:${
        element.marginInlineEnd || ""
      };margin-inline-start:${element.marginInlineStart || ""};margin-left:${
        element.marginLeft || ""
      };margin-right:${element.marginRight || ""};margin-top:${
        element.marginTop || ""
      };mask:${element.mask || ""};mask-border:${
        element.maskBorder || ""
      };mask-border-mode:${element.maskBorderMode || ""};mask-border-outset:${
        element.maskBorderOutset || ""
      };mask-border-repeat:${
        ...
        element.overflowClipMargin || ""
      };overflow-inline:${element.overflowInline || ""};overflow-wrap:${
        element.overflowWrap || ""
      };overflow-x:${element.overflowX || ""};overflow-y:${
        element.overflowY || ""
      };overscroll-behavior:${
        ...
        element.scrollPaddingTop || ""
      };scroll-snap-align:${element.scrollSnapAlign || ""};scroll-snap-stop:${
        element.scrollSnapStop || ""
      };scroll-snap-type:${element.scrollSnapType || ""};scrollbar-color:${
        element.scrollbarColor || ""
      };scrollbar-gutter:${element.scrollbarGutter || ""};scrollbar-width:${
        ...
        element.textCombineUpright || ""
      };text-decoration:${element.textDecoration || ""};text-decoration-color:${
        ...
        element.whiteSpace || ""
      };widows:${element.widows || ""};width:${
        element.width || ""
      };will-change:${element.willChange || ""};word-break:${
        element.wordBreak || ""
      };word-spacing:${element.wordSpacing || ""};writing-mode:${
        element.writingMode || ""
      };z-index:${element.zIndex || ""};align-tracks:${
        element.alignTracks || ""
        ...
        element.initialLetterAlign || ""
      };justify-tracks:${element.justifyTracks || ""};line-height-step:${
        element.lineHeightStep || ""
      };margin-trim:${element.marginTrim || ""};mastimesonry-auto-flow:${
        element.masonryAutoFlow || ""
      };math-depth:${element.mathDepth || ""};math-shift:${
        element.mathShift || ""
      };math-style:${element.mathStyle || ""};offset-position:${
        element.offsetPosition || ""
      };ruby-align:${element.rubyAlign || ""};scroll-timeline:${
        ...
        element.textDecorationSkip || ""
      };text-size-adjust:${element.textSizeAdjust || ""};`)
    : null;

  $: if (styleString) {
    finalStyleString = getFinalStyleString();
    brownFinalStyleString = finalStyleString + "background: brown;";
  }
...
{#if ready}
  <div
    style={`${
      $elementHoveredInDOMVisualizer === element._id
        ? brownFinalStyleString
        : finalStyleString
    }`}
    class={className}
  ...
  >
    {#if element.type === "div"}
      <Div
        ...
        styleString={$elementHoveredInDOMVisualizer === element._id
          ? brownFinalStyleString
          : finalStyleString}
